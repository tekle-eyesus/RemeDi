...
class _AddMedicationScreenState extends ConsumerState<AddMedicationScreen> {
  ...
  int _interval = 1;
  DateTime? _endDate; // New End Date Field
  File? _selectedImage; // Local image file
  ...
  Future<void> _saveMedication() async {
    ...
    try {
      ...
      final newMed = Medication(
        ...
        type: _selectedType,
        color:
            '#${_selectedColor.value.toRadixString(16).substring(2)}', // Hex Color
        ...
        endDate: _endDate, // Handled here
        notes: _notesController.text,
        imageUrl: uploadedImageUrl, // Handled here
      );
